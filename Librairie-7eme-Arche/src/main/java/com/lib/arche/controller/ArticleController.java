 ...
 */ 
 ...
 /**
  * Cette annotation est utilisée sur les classes Java qui jouent le rôle de controleur dans notre application.
  * L'annotation @Controller permet l'auto-détection des classes de composants dans les définitions du chemin de
  *  la classe et l'enregistrement automatique des beans.
  */
@Controller
public class ArticleController {
	/**
	  *  L'annotation @Autowired permet d'activer l'injection automatique de dependance.
	  */
	@Autowired
	ArticleRepository articleRepository;
	/**
	  * Cette annotation est utilisée pour mapper des requetes HTTP GET sur des methodes de gestionnaire specifiques
     * @GetMapping est une annotation composee qui agit comme un raccourci pour @RequestMapping
	...
	public String updateProduit(@ModelAttribute("article") Article article,
